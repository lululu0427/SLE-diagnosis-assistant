...
#include <limits.h>
int main(){
    int ANA=INT_MAX,b=0,c=0,ans=0,flag=0,SLE=0,point=0,t=0,q=0,cscore,imscore,gg=0,niflag=0,sledainum=0,confirm;
...
//data input
    do
    {
        printf("He/she is classified as a SLE patient?\ninput \"Y\" means Yes, input \"N\" means No.\n");
    ...
    if(issle=='N'){
        ...
        if(ANA<80 && ANA>0){
            ...
            for (int a = 1; a <= 8;a++){
                ...
                for (; b <= 24;b++){
                    ...
                    if(cillness[b][0]=='c'){
                        gg=0;
                        confirm = 0;
                        printf("Here are the answer you input:\n");
                        for (int i = 0; i < 24;i++){
                            if(cillness[i][0]=='x'){
                                continue;
                            }
            ...
            do{
                printf("Do you want to confirm your answer about clinical conditions?\n'\"y\" means yes,\"n\" means no\n");
                fflush(stdin),scanf("%c", &change),fflush(stdin);
            ...
            do{
                printf("Do you want to confirm your answer about Immunology conditions?\n'\"y\" means yes,\"n\" means no\n");
                fflush(stdin),scanf("%c", &change),fflush(stdin);
                change=toupper(change);
            } while (change != 'Y' && change != 'N');
            if( change == 'Y'){
